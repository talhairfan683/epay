...
export const Epaycoin = () => {
  ...
  return (
    <div className='container'>
      <div className='text-2xl font-bold mt-24'>Coin</div>
      <div className='row'>
          ...
          <div className='row border-solid border-2 border-gray-40 rounded-2xl h-20 mt-10'>
            ...
            <div className='col-3 float-end'>
              <button
                ...
                className="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-6 py-2.5 me-2 mb-3 dark:bg-red-500 dark:hover:bg-red-700 ml-24
                 mt-3 dark:focus:ring-red-500"
              >
                Edit Details
              </button>
            </div>
